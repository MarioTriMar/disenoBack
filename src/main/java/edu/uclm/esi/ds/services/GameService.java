...
public class GameService {
	...
	public Match makeMovement(Map<String, ?> info) {
		...
		enviarMatchActualizado(httpSessionRival, match);
	...
	private void enviarMatchActualizado(String httpSessionRival, Match match) {
		...
		jso.put("boards", match.getBoards());
		jso.put("id", match.getId());
		jso.put("player", match.getPlayer());
		jso.put("ready", true);
